...
// Flash configuration sector settings for STM32F407
// Using the last sector (Sector 11) for configuration storage
// Sector 11: 0x080E0000 - 0x080FFFFF (128KB)
#define CONFIG_FLASH_SECTOR_NUM     11
#define CONFIG_FLASH_BASE_ADDR      0x080E0000
