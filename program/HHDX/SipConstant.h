...
// //��̬�˿�Э�̳���
// #define PORT_REQUEST_TIMEOUT    3000    // �˿�����ʱʱ�� (3��)
// #define PORT_REQUEST_MAX_RETRY  3       // �˿�����������Դ���
// #define FILE_BLOCK_SIZE         1024    // �ļ��ֿ��С (1KB)
// #define FILE_TRANSFER_TIMEOUT   5000    // �ļ����䳬ʱʱ�� (5��)

// // ��̬�˿�Э����Ϣ����
// #define MSG_TYPE_PORT_REQUEST   0x10    // �˿�����
// #define MSG_TYPE_PORT_RESPONSE  0x11    // �˿���Ӧ
// #define MSG_TYPE_PORT_VERIFY    0x12    // �˿���֤
// #define MSG_TYPE_FILE_START     0x20    // �ļ����俪ʼ
// #define MSG_TYPE_FILE_DATA      0x21    // �ļ����ݿ�
// #define MSG_TYPE_FILE_END       0x22    // �ļ��������
// #define MSG_TYPE_FILE_ACK       0x23    // �ļ�����ȷ��
...
#define FLASH_TX_SIP				0xE0	//��Flash������pc��
#define DIAL_NUM_TX_SIP			0xE1	//ר�÷���������
#define HOOKOFF_TX_SIP			0xE2	//����#���Ż򲦺�6sʱ�䵽/�ز�/ר�÷���tj��
