...
//			I2S2_SampleRate_Set(44100);	//���ò���
			AUDIO_play_mode();		//�����Music
			TEL_HandfreeSPK_on();	//������SPK	
			break;
...
//�� �޸��˼��޸�ʱ�� ��
//��  ��  ��  ԭ  ��  ��
//��  ��  ��  ��  ��  ��Call_ID:(Mac��4�ֽ�+gSipRamdom1)-������ʱ����-(IP address+gSipRamdom2)
//						��: Call_ID:xxxxxxxx-xxxxxxxxxxxx-xxxxxxxx
//-----------------------------------------------------------------------------
...
//�� �޸��˼��޸�ʱ�� ��
//��  ��  ��  ԭ  ��  ��
//��  ��  ��  ��  ��  ��From/To tag=(gSipRamdom1+ntohl(gSipRamdom2))(gSipRamdom1-ntohl(gSipRamdom2))
...
//�� �޸��˼��޸�ʱ�� ��
//��  ��  ��  ԭ  ��  ��
//��  ��  ��  ��  ��  ��Via: branch=(gSipRamdom1+gSipRamdom2+ntohl(gSipRamdom1))
//						��: branch=z9hG4bKxxxxxxxxxxxxxxxx
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//1.���ע��ɹ���ÿ��60sע��һ��
//2.���û��ע��ɹ�ÿ��3��ע��һ�Σ�ע��20�κ�ͣ120s
//-----------------------------------------------------------------------------
void SIP_RegisterTx(void)
{
	...
	flag =0;
//	gsSipRxFlag.ok_reg =1;//test?????? �յ�OK =1	
